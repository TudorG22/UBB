...
- Generare carti aleatorii
- Generare clienti aleatorii

- Raport: cele mai inchiriate carti
- Raport: clienti cu imprumuturi ordonati dupa nume
- Raport: clienti cu imprumuturi ordonati descrescator dupa numarul de carti imprumutate
- Raport: primii 20% cei mai activi clienti (dupa numarul de carti imprumutate)
- Raport: autori ordonati dupa numarul total de imprumuturi
...
### Iteratia 3 
- rapoarte
- restructurare (ui, domain, repo, service)
