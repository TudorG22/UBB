...
from actiuni import (
    ...
    afiseaza_carti_inchiriate_populare,
    afiseaza_clienti_inchiriaza_sortati_dupa_nume,
    afiseaza_clienti_inchiriaza_sortati_dupa_numar,
    afiseaza_clienti_top20_activi,
    afiseaza_autori_inchiriati,
    genereaza_carti,
    genereaza_clienti,
)
    ...
    while True:
        ...
        try:
            if opt == "1":
                ...
                afiseaza_carti_inchiriate_populare(clienti)

            elif opt == "19":
                afiseaza_clienti_inchiriaza_sortati_dupa_nume(clienti)

            elif opt == "20":
                afiseaza_clienti_inchiriaza_sortati_dupa_numar(clienti)

            elif opt == "21":
                afiseaza_clienti_top20_activi(clienti)

            elif opt == "22":
                afiseaza_autori_inchiriati(clienti)
