class Console:
    def __init__(self, service):
        """Initializeaza consola cu service-ul aplicatiei."""
        self._srv = service

    def _tipareste_costume_sortate(self):
        """Cere ordinea si afiseaza costumele sortate dupa tip."""
    ...
    def _adauga_inchiriere(self):
        """Citeste datele necesare si adauga o inchiriere."""
    ...
    def run(self):
        """Ruleaza bucla de comenzi a aplicatiei."""
        comenzi = {
