...
constexpr int cmdUndo = 4;
constexpr int cmdShowAll = 5;
constexpr int cmdSearch = 6;
constexpr int cmdFilter = 7;
constexpr int cmdSort = 8;
constexpr int cmdReportGenres = 9;
constexpr int cmdCartEmpty = 10;
constexpr int cmdCartAdd = 11;
...
void UI::uiUndo() const {
    service.undo();
    showOutput("Undo realizat.\n");
}
